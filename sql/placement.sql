...
(13, 'Adarsha', 'Cognizant Technology Solutions', 'Selected', NULL);
...
(2, 'admin1', 'Hello everybody this is the demo text on your feed youll receive further updates in the same way!!', '26-12-2024', '19:14:39'),
(4, 'vp', 'Infosys company has been added interested students can apply !!\r\n-Admin', '26-12-2024', '20:04:42'),
(7, 'admin1', 'More IT and BPO companies added! -Admin', '2024-12-', '12:31:27'),
(5, 'admin1', 'Do not post unnecessary comments!!', '2024-12-25', '22:48:06'),
(6, 'admin1', '4 more companies added checkout!!!\r\n-Admin', '2024-12-26', '22:50:41'),
(8, 'admin1', 'Infosys interview is being held tomorrow at 10:00 AM in college campus', '2024-12-27', '11:10:10');
...
-- CREATE TABLE student(id integer(100) PRIMARY KEY AUTO_INCREMENT, uname varchar(100), fname varchar(100), lname varchar(100), email varchar(100), phone varchar(11), course varchar(100), percentage varchar(10))ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=latin1;


-- INSERT INTO `student` (`id`, `uname`,  `fname`, `lname`, `email`, `phone`, `course`, `percentage`) VALUES
-- (10, 'bharath', 'Bharath', 'N', 'bharath@gmail.com', '9632629993', 'BCOM', '82');
...
CREATE TRIGGER before_insert_studentlogin
BEFORE INSERT ON studentlogin
FOR EACH ROW
BEGIN
    IF NEW.percentage < 50 THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Percentage must be 50 or above.';
    END IF;
END; //
DELIMITER ;
